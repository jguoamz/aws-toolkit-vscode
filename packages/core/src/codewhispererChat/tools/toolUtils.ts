...
import { WebScrape, WebScrapeParams } from './webScrape'
...
export type Tool =
    ...
    | { type: ToolType.WebScrape; tool: WebScrape }
...
export class ToolUtils {
    static displayName(tool: Tool): string {
        switch (tool.type) {
            ...
            case ToolType.WebScrape:
                return 'Scrape web page'
        }
    }
    ...
    static tryFromToolUse(value: ToolUse): Tool | ToolResult {
        ...
        try {
            switch (value.name) {
                ...
                case ToolType.WebScrape:
                    return {
                        type: ToolType.WebScrape,
                        tool: new WebScrape(value.input as unknown as WebScrapeParams),
                    }
                default:
                    return {
                        toolUseId: value.toolUseId,
